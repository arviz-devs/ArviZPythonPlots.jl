...
@testset "conversions" begin
    @testset "PSISLOOResult" begin
        ...
        loo_py_result = ArviZPyPlot.arviz.loo(idata; pointwise=true, reff=1)
        py_loo_result = ArviZPyPlot.topandas(Val(:ELPDData), loo_result)
    ...
    @testset "WAICResult" begin
        ...
        waic_py_result = ArviZPyPlot.arviz.waic(idata; pointwise=true)
        py_waic_result = ArviZPyPlot.topandas(Val(:ELPDData), waic_result)
